...
# of a given galaxy and simulation snapshot
    ...
    def COM_P(self, volDec, delta):
        ...
        ----------
        volDec: float 
            Factor to decrease volume of galaxy by when trying to converge on COM positon:
        delta : float
        ...
        # will re-start at some factor volDec of the radius (reduced radius)                                                           

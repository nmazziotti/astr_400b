...
G = G.to(u.Mpc**3/u.Msun/u.s**2) # Convert G to Mpc^3 /( Msun s^2 )
...
class HaloShape:
    ...
    def PlotEllipses(self, axis1, axis2, sma=10):
        ...
        ax.set_ylim(0,1)
        ax.axvline(r200, c='magenta', linestyle=':', label=r"M33 $R_{200}$")
        ax.axvline(r200/2, c='magenta', linestyle='--', label=r"M33 $R_{200}$/2")
        ax.axvline(r200/4, c='magenta', linestyle='-.', label=r"M33 $R_{200}$/4")
        ax.legend()
        ...
        # ax[1].axvline(r200, c='magenta', linestyle=':', label=r"M33 $R_{200}$")
        # ax[1].axvline(r200/2, c='magenta', linestyle='--', label=r"M33 $R_{200}$/2")
        # ax[1].axvline(r200/4, c='magenta', linestyle='-.', label=r"M33 $R_{200}$/4")
        # ax[1].legend()
        ...
        #     ax.set_ylim(y0 - w, y0 + w)
            ...
            isos = np.empty(len(smas), dtype=object)

...
class HaloShape:
    ...
    def PlotEllipses(self, axis1, axis2, sma=10):
        ...
        ax.set_ylim(0,1)
        ax.axvline(r500, c='magenta', linestyle=':', label=r"M33 $R_{500}$")
        ax.axvline(r500/2, c='magenta', linestyle='--', label=r"M33 $R_{500}$/2")
        ax.axvline(r500/4, c='magenta', linestyle='-.', label=r"M33 $R_{500}$/4")
        ax.legend()
        ...
        plt.savefig(save_ellipses_dir + self.filename[:-4] + '.png', bbox_inches='tight')
    ...
    #     ax.set_ylim(y0 - w, y0 + w)
        ...
        plt.savefig(save_projections_dir + self.filename[:-4] + '.png', bbox_inches='tight')
